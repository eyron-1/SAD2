...
export default function PublicLayout() {
  ...
  const bgyName = barangay?.name || 'Barangay Portal';
    ...
    <div className="min-h-screen flex flex-col bg-slate-50 font-body">
      ...
      <header className="bg-civic-dark text-white border-b border-slate-800 sticky top-0 z-40 shadow-md">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          <Link to={`/b/${slug}`} className="flex items-center gap-3 group">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-300 font-medium">Public Transparency & Governance Portal</p>
            </div>
          </Link>
